...
function Event({ newEvent, setNewEvent, handleAddEvent, handleUpdateEvent, isUpdating, errorMessage }) {
  return (
    <div className="new-event" style={{ marginTop: '20px' }}>
      ...
      <div>
        ...
        <InputLabel htmlFor="bc" className="form-label" style={{ fontSize: '20px', marginBottom: '-18px' }}>
          ...
          <br />
        <Select style={{width:"250px", marginBottom:"22 px"}}  >
        ...
        {isUpdating ? 'Update Event' : 'Send Request'}
        </Button>
        </div>
      </div>
    </div>
